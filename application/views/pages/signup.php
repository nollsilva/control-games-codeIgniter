...
<body class="text-center">
  ...
  <form class="form-signin" method="post" action="<?= base_url() ?>signup/store">
    ...
    <h1 class="h3 mb-3 font-weight-normal">Faca seu cadastro</h1>
    ...
    <input type="text" name="country" id="inputCountry" class="form-control" placeholder="Pais" required autofocus>
    ...
    <p>
      <a href="<?= base_url() ?>login">ja tem uma conta?</a>
    </p>
